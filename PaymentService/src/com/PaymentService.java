...
public class PaymentService extends HttpServlet {
   ...
   public PaymentService() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = innoObj.insertPayment(request.getParameter("holder_name"),      
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = innoObj.updatePayment(paras.get("hidpay_idSave").toString(),     
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = innoObj.deletePayment(paras.get("pay_id").toString());  
